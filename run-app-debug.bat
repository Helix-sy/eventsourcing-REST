...
echo Starting application with debug enabled...
cd %~dp0
java -jar target\cart-3.3.2.jar --spring.profiles.active=no-containers --debug --application.cosmetics.enabled=true